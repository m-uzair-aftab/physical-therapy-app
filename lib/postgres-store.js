...
let pool;
let exerciseCatalogSynced = false;
...
async function syncExerciseCatalog(client) {
  if (exerciseCatalogSynced) return;
  ...
  exerciseCatalogSynced = true;
}

export async function readPostgresData() {
  return withClient(async (client) => {
    await syncExerciseCatalog(client);
